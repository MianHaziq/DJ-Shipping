...
import { company, contact, memberships } from "@/lib/data";

export default function HomeHero() {
  return (
    <section className="relative isolate flex min-h-svh items-center overflow-hidden bg-deep pt-20">
      ...
      />
      <div
        className="absolute inset-0 bg-linear-to-r from-deep via-deep/90 to-deep/45"
        aria-hidden="true"
      />
      <div
        className="absolute inset-0 bg-linear-to-t from-deep via-transparent to-deep/30"
        aria-hidden="true"
      />
        ...
        <div className="hero-rise max-w-3xl">
          <div className="flex items-center gap-3">
            ...
            <span className="eyebrow text-accent">
              Licensed Freight Forwarder · Est. {company.established}
            </span>
          </div>

          <h1 className="mt-7 font-display text-[clamp(2.6rem,1.4rem+4.6vw,5rem)] font-extrabold leading-[0.98] tracking-tight text-white text-balance">
            25 Years of{" "}
            <span className="text-gradient-sky">End-to-End</span> Supply Chain
            Reliability
          </h1>

          <p className="mt-7 max-w-xl text-lg leading-relaxed text-on-deep-muted">
      ...
      {/* Decorative manifest tag — sits clear of the metrics strip, which
          overlaps the hero's bottom edge by ~80px (MetricsStrip md:-mt-20) */}
      <div className="absolute bottom-28 right-8 z-10 hidden lg:block">
